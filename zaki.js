...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
    ...
    + 'FN:zigxyXD\n'
    + 'ORG:𝙸 𝙰𝚖 zigxy;\n'
    + 'item1.TEL;type=CELL;type=VOICE;waid=6281334109123:+62 813-3410-9123\n' 
    + 'item1.X-ABLabel:Creator Zigxy - MDt\n'
    + 'item2.EMAIL;type=INTERNET:zigxypro@gmail.com\n'
    + 'item2.X-ABLabel:Email\n'
    + 'item3.URL:https://www.instagram.com/p/Cbz_YoAvymD/?igshid=YmMyMTA2M2Y=\n'
...
Zaki.sendMessage(m.chat, { contacts: { displayName: '𝙸 𝙰𝚖 𝙺𝙸𝚉𝙰𝙺𝙸𝚇𝙳', contacts: [{ vcard }] } }, { quoted: m })
            ...
            break            
                    case 'bug': case 'report': {
                    	...
                    	Zaki.sendMessage(`6281334109123@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
                    ...
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                            	...
                            	urlButton: {
                                displayText: 'Group',
                                    url: 'https://chat.whatsapp.com/H2DXyjA6VqT42Mogg4yTWK'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Menu',
